Notebook filament_extraction_from_mock_data.nb contains the step-by-step procedure for extracting the filament network from data in the file mock_data.txt.
